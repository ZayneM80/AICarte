...
CREATE TABLE `dish` (
  ...
  `taste` varchar(32) COLLATE utf8_bin DEFAULT NULL COMMENT '口味(麻辣/酸辣/咸鲜/清淡/甜/蒜香) AI推荐用',
  `spiciness` varchar(32) COLLATE utf8_bin DEFAULT NULL COMMENT '辣度(不辣/微辣/中辣/特辣) AI推荐用',
...
-- 兼容旧表：若已存在则添加字段
ALTER TABLE `dish` ADD COLUMN IF NOT EXISTS `taste` varchar(32) COLLATE utf8_bin DEFAULT NULL COMMENT '口味(麻辣/酸辣/咸鲜/清淡/甜/蒜香) AI推荐用';
ALTER TABLE `dish` ADD COLUMN IF NOT EXISTS `spiciness` varchar(32) COLLATE utf8_bin DEFAULT NULL COMMENT '辣度(不辣/微辣/中辣/特辣) AI推荐用';
